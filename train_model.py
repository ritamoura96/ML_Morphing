...
X_train, y_train, X_test, y_test, scaler_fit = data_pre_processing(df, number_nodes, number_frames)
...
for model in models_to_train:
    ...
    # predict
    all_predictions = make_predictions(X_test, scaler_fit, model_fit)
